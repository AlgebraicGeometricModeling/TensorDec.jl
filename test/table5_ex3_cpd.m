function [min,med,max,t,Ni]=table5_ex3_cpd(eps)
n=5;
r=12;
N=20;
d1=zeros(N,1);
...
for s= 1:N
    ...
    U0=U0([1 1 1 1 1 1]);
    T0=cpdgen(U0);
    E0=randn(n,n,n,n,n,n)+1i*randn(n,n,n,n,n,n);
    E=zeros(n,n,n,n,n,n)+1i*zeros(n,n,n,n,n,n);
    ...
    z=sol{1};
    T3=zeros(n,n,n,n,n,n)+1i*zeros(n,n,n,n,n,n);
    for j= 1:r
        b=outprod(z(:,j),z(:,j),z(:,j),z(:,j),z(:,j),z(:,j));
        T3=T3+b;
    end
